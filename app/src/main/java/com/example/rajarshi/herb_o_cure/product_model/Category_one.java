...
public class Category_one {
    ...
    public static ArrayList<Category_one> getData() {

        ArrayList<Category_one> datalist = new ArrayList<>();
        ...
        for (int i = 0; i < images.length; i++) {
            Category_one landscape = new Category_one();
    ...
    private static String[] getDescrition() {
        String[] descrip = {"Description of a", "Description of b"};
        return descrip;
    }
